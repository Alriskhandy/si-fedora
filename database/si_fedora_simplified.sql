-- =====================================================
-- SI-FEDORA Database Schema (SIMPLIFIED VERSION)
-- Generated from Laravel Migrations (Optimized)
-- Date: 2026-02-03
-- 
-- PERBAIKAN & PENYEDERHANAAN:
-- 1. Menghapus tabel persyaratan_dokumen (redundan)
-- 2. Menggabungkan 3 tabel assignment menjadi 1
-- 3. Menggabungkan permohonan_dokumen + dokumen_tahapan menjadi 1 tabel 'dokumen'
-- 4. Menghapus fasilitasi_bab & fasilitasi_urusan (redundan)
-- 5. Menggabungkan hasil_fasilitasi_sistematika + hasil_fasilitasi_urusan
-- 6. Standardisasi naming: created_by, updated_by, verified_by
-- 7. Total tabel berkurang dari 50+ menjadi ~40 tabel
-- =====================================================
...
CREATE TABLE IF NOT EXISTS `jadwal_fasilitasi` (
  ...
  CONSTRAINT `jadwal_fasilitasi_created_by_foreign` 
...
-- =====================================================
-- 7. TAHAPAN & ASSIGNMENT TABLES (SIMPLIFIED)
-- =====================================================
...
-- ✅ SIMPLIFIED: Gabungkan 3 tabel assignment menjadi 1
CREATE TABLE IF NOT EXISTS `permohonan_assignments` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `permohonan_id` BIGINT UNSIGNED NOT NULL,
  `user_id` BIGINT UNSIGNED NOT NULL,
  `role` ENUM('koordinator', 'verifikator', 'fasilitator') NOT NULL,
  `is_pic` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Person in Charge / Ketua Tim',
  `assigned_by` BIGINT UNSIGNED NULL,
  `created_at` TIMESTAMP NULL,
  `updated_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `permohonan_assignments_permohonan_id_role_index` (`permohonan_id`, `role`),
  INDEX `permohonan_assignments_user_id_role_index` (`user_id`, `role`),
  UNIQUE KEY `permohonan_user_role_unique` (`permohonan_id`, `user_id`, `role`),
  CONSTRAINT `permohonan_assignments_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `permohonan_assignments_user_id_foreign` 
    FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `permohonan_assignments_assigned_by_foreign` 
    FOREIGN KEY (`assigned_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- =====================================================
-- 8. DOKUMEN TABLES (SIMPLIFIED)
-- =====================================================

-- ✅ SIMPLIFIED: Gabungkan permohonan_dokumen + dokumen_tahapan menjadi 1
CREATE TABLE IF NOT EXISTS `dokumen` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `permohonan_id` BIGINT UNSIGNED NOT NULL,
  `tahapan_id` BIGINT UNSIGNED NULL,
  `kelengkapan_id` BIGINT UNSIGNED NULL,
  `kategori` ENUM('permohonan', 'verifikasi', 'pelaksanaan', 'hasil') NOT NULL DEFAULT 'permohonan',
  `nama_dokumen` VARCHAR(255) NOT NULL,
  ...
  `deleted_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `dokumen_permohonan_id_kategori_index` (`permohonan_id`, `kategori`),
  INDEX `dokumen_permohonan_id_tahapan_id_index` (`permohonan_id`, `tahapan_id`),
  INDEX `dokumen_status_index` (`status`),
  INDEX `dokumen_created_at_index` (`created_at`),
  CONSTRAINT `dokumen_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dokumen_tahapan_id_foreign` 
    FOREIGN KEY (`tahapan_id`) REFERENCES `master_tahapan` (`id`) ON DELETE SET NULL,
  CONSTRAINT `dokumen_kelengkapan_id_foreign` 
    FOREIGN KEY (`kelengkapan_id`) REFERENCES `master_kelengkapan_verifikasi` (`id`) ON DELETE SET NULL,
  CONSTRAINT `dokumen_uploaded_by_foreign` 
    FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `dokumen_verified_by_foreign` 
...
CREATE TABLE IF NOT EXISTS `dokumen_revisi` (
  ...
  `created_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `dokumen_revisi_dokumen_id_created_at_index` (`dokumen_id`, `created_at`),
  CONSTRAINT `dokumen_revisi_dokumen_id_foreign` 
...
CREATE TABLE IF NOT EXISTS `laporan_verifikasi` (
  ...
  CONSTRAINT `laporan_verifikasi_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `laporan_verifikasi_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `penetapan_jadwal_fasilitasi` (
  ...
  CONSTRAINT `penetapan_jadwal_fasilitasi_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `undangan_pelaksanaan` (
  ...
  CONSTRAINT `undangan_pelaksanaan_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pelaksanaan_catatan` (
  ...
  CONSTRAINT `pelaksanaan_catatan_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `pelaksanaan_catatan_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `hasil_fasilitasi` (
  ...
  CONSTRAINT `hasil_fasilitasi_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `hasil_fasilitasi_updated_by_foreign` 
    FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ✅ SIMPLIFIED: Gabungkan sistematika + urusan menjadi 1 tabel
CREATE TABLE IF NOT EXISTS `hasil_fasilitasi_detail` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `hasil_fasilitasi_id` BIGINT UNSIGNED NOT NULL,
  `tipe` ENUM('bab', 'urusan') NOT NULL,
  `master_bab_id` BIGINT UNSIGNED NULL,
  `sub_bab` VARCHAR(255) NULL COMMENT 'Sub bab jika ada',
  `master_urusan_id` BIGINT UNSIGNED NULL,
  `catatan` TEXT NOT NULL COMMENT 'Catatan penyempurnaan untuk bab atau masukan untuk urusan',
  `created_by` BIGINT UNSIGNED NOT NULL,
  `created_at` TIMESTAMP NULL,
  `updated_at` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `hasil_fasilitasi_detail_hasil_fasilitasi_id_tipe_index` (`hasil_fasilitasi_id`, `tipe`),
  INDEX `hasil_fasilitasi_detail_master_bab_id_index` (`master_bab_id`),
  INDEX `hasil_fasilitasi_detail_master_urusan_id_index` (`master_urusan_id`),
  CONSTRAINT `hasil_fasilitasi_detail_hasil_fasilitasi_id_foreign` 
    FOREIGN KEY (`hasil_fasilitasi_id`) REFERENCES `hasil_fasilitasi` (`id`) ON DELETE CASCADE,
  CONSTRAINT `hasil_fasilitasi_detail_master_bab_id_foreign` 
    FOREIGN KEY (`master_bab_id`) REFERENCES `master_bab` (`id`) ON DELETE SET NULL,
  CONSTRAINT `hasil_fasilitasi_detail_master_urusan_id_foreign` 
    FOREIGN KEY (`master_urusan_id`) REFERENCES `master_urusan` (`id`) ON DELETE SET NULL,
  CONSTRAINT `hasil_fasilitasi_detail_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `penetapan_perda` (
  ...
  CONSTRAINT `penetapan_perda_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `penetapan_perda_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tindak_lanjut` (
  ...
  CONSTRAINT `tindak_lanjut_permohonan_id_foreign` 
    FOREIGN KEY (`permohonan_id`) REFERENCES `permohonan` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tindak_lanjut_created_by_foreign` 
    FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- =====================================================
-- ✅ 1. Removed `persyaratan_dokumen` (redundant with master_kelengkapan_verifikasi)
-- ✅ 2. Merged 3 assignment tables into 1: `permohonan_assignments`
-- ✅ 3. Merged `permohonan_dokumen` + `dokumen_tahapan` into 1: `dokumen`
-- ✅ 4. Removed `fasilitasi_bab` & `fasilitasi_urusan` (redundant)
-- ✅ 5. Merged `hasil_fasilitasi_sistematika` + `hasil_fasilitasi_urusan` into 1: `hasil_fasilitasi_detail`
-- ✅ 6. Standardized naming: created_by, updated_by, verified_by, uploaded_by
-- ✅ 7. Total tables reduced from 50+ to ~40 tables
-- ✅ 8. Improved query performance with better indexes
-- ✅ 9. Clearer business logic flow
-- ✅ 10. Easier to maintain and understand
-- =====================================================
-- END OF SCHEMA
-- =====================================================
