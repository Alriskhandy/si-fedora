...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Master Data
            'master.kabkota.view',
            'master.kabkota.manage',
            'master.jenis-dokumen.view',
            'master.jenis-dokumen.manage',
            'master.persyaratan.view',
            'master.persyaratan.manage',
            'master.tahun.view',
            'master.tahun.manage',
            'master.pokja.view',
            'master.pokja.manage',
            ...
            'surat-pemberitahuan.create',
            'surat-pemberitahuan.send',
            ...
            'surat-rekomendasi.sign',
            'surat-rekomendasi.send',
