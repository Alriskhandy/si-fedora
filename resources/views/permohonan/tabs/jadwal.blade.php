...
@if (!$permohonan->penetapanJadwal)
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <h5 class="mb-2" style="color: #0d3b4d;">Belum Terdapat Jadwal</h5>
        </div>
    </div>
@else
    <!-- Jadwal Sudah Ditetapkan -->
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-header" style="background: linear-gradient(135deg, #a0d9ef 0%, #7bc4e3 100%); border: none;">
                ...
                @if (auth()->user()->hasRole('pemohon'))
                    @if ($permohonan->undanganPelaksanaan->konfirmasi_kehadiran === null)
                        <div class="alert alert-warning border-0 mb-3"
                            ...
                            <strong>Perhatian:</strong> Mohon konfirmasi kehadiran Anda untuk pelaksanaan fasilitasi.
                        </div>
