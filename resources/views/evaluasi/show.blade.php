            ...
            <div class="col-lg-12 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse($permohonan->permohonanDokumen as $index => $dokumen)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $dokumen->persyaratanDokumen->nama ?? 'Dokumen Tidak Ditemukan' }}
                                                </td>
                                                <td>
                                                    @if ($dokumen->is_ada)
                                                ...
                                                <td>
                                                    @if ($dokumen->file_path)
                                                        <a href="{{ url('storage/' . $dokumen->file_path) }}"
                        ...
                        <!-- Form Evaluasi -->
                        <form action="{{ route('evaluasi.store', $permohonan) }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="form-control" id="file_draft" name="file_draft"
                                    accept=".pdf,.doc,.docx">
                                @if ($evaluasi?->file_draft)
                                    <div class="mt-2">
                                        <a href="{{ route('evaluasi.download-draft', $evaluasi) }}" target="_blank"
