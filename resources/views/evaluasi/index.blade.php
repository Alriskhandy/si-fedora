                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-label-warning">Sedang Dievaluasi</span>
                                    </td>
                                    <td>{{ $item->created_at->format('d M Y') }}</td>
                                    <td>
                                        <a href="{{ route('evaluasi.show', $item) }}" class="btn btn-sm btn-primary">
                                            <i class="bx bx-show me-1"></i> Evaluasi
                                        </a>
                                    </td>
                                </tr>
                                @empty
