<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (auth()->user()->hasRole('admin_peran'))
            ...
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Verifikasi & Validasi</span>
            </li>
            ...
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Pelaksanaan</span>
            </li>
            ...
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Dokumen Hasil</span>
            </li>
        ...
        @if (auth()->user()->hasRole('pemohon'))
            ...
            <li class="menu-item {{ request()->routeIs('my-undangan.*') ? 'active' : '' }}">
                <a href="{{ route('my-undangan.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-envelope-open"></i>
                    <div data-i18n="Undangan">Undangan Pelaksanaan</div>
                </a>
            </li>
        @endif
        ...
        @if (auth()->user()->hasRole('verifikator'))
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Verifikasi & Evaluasi</span>
            </li>
            <li
                class="menu-item {{ request()->routeIs('permohonan.*', 'permohonan-dokumen.*', 'verifikasi.*') ? 'active' : '' }}">
                <a href="{{ route('permohonan.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-folder-open"></i>
                    <div data-i18n="Permohonan">Daftar Permohonan</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('my-undangan.*') ? 'active' : '' }}">
                <a href="{{ route('my-undangan.index') }}" class="menu-link">
        ...
        @if (auth()->user()->hasRole('fasilitator'))
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Fasilitasi</span>
            </li>
            <li class="menu-item {{ request()->routeIs('my-undangan.*') ? 'active' : '' }}">
                <a href="{{ route('my-undangan.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-envelope-open"></i>
        ...
        @if (auth()->user()->hasRole('auditor'))
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Audit & Monitoring</span>
            </li>
            <li class="menu-item {{ request()->routeIs('auditor.permohonan.*') ? 'active' : '' }}">
                <a href="{{ route('permohonan.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-folder-open"></i>
                    <div data-i18n="Permohonan">Data Permohonan</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('auditor.verifikasi.*') ? 'active' : '' }}">
                <a href="{{ route('laporan-verifikasi.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-file-find"></i>
                    <div data-i18n="Verifikasi">Data Verifikasi</div>
                </a>
            </li>
            <li class="menu-item {{ request()->routeIs('auditor.fasilitasi.*') ? 'active' : '' }}">
                <a href="{{ route('hasil-fasilitasi.index') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-edit-alt"></i>
                    <div data-i18n="Fasilitasi">Data Fasilitasi</div>
                </a>
            </li>

            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Laporan & Dokumen</span>
            </li>
