...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">Input Masukan / Catatan Penyempurnaan Dokumen Perencanaan kabupaten/kota.</p>
                            </div>
                        </div>
        ...
        <!-- Row 2: Tugas Evaluasi and Summary Cards -->
        <div class="row g-4 mb-4">
            <div class="col-lg-8 col-md-12">
                <div class="card h-100">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse($stats['my_evaluasi_tasks'] as $permohonan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('evaluasi.show', $permohonan->id) }}"
                        ...
                        <div class="card h-100">
                            <div class="card-body p-3">
                                ...
                                <div class="text-center">
                                    <h2 class="mb-0 fw-bold">{{ $stats['my_evaluasi'] }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="card h-100">
                            <div class="card-body p-3 d-flex flex-column justify-content-center">
                                ...
                                <div class="text-center">
                                    <h3 class="mb-0 fw-bold">{{ $stats['completed_evaluasi'] }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">Informasi Tim Pokja</h5>
                    </div>
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                            ...
                            <div>
                                <small class="text-muted d-block">Tim Fasilitator</small>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <strong>{{ $stats['my_evaluasi'] }}</strong>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="small">Selesai Bulan Ini</span>
                                <strong>{{ $stats['completed_evaluasi'] }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
