...
@section('title', 'Edit Surat Pemberitahuan')
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit Surat Pemberitahuan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('surat-pemberitahuan.update', $suratPemberitahuan) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('jadwal_fasilitasi_id') is-invalid @enderror" 
                                ...
                                @foreach($jadwalFasilitasi as $jadwal)
                                    <option value="{{ $jadwal->id }}" {{ old('jadwal_fasilitasi_id', $suratPemberitahuan->jadwal_fasilitasi_id) == $jadwal->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('kabupaten_kota_id') is-invalid @enderror" 
                                ...
                                @foreach($kabupatenKota as $kabupaten)
                                    <option value="{{ $kabupaten->id }}" {{ old('kabupaten_kota_id', $suratPemberitahuan->kabupaten_kota_id) == $kabupaten->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_surat') is-invalid @enderror" 
                                   id="nomor_surat" name="nomor_surat" value="{{ old('nomor_surat', $suratPemberitahuan->nomor_surat) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_surat') is-invalid @enderror" 
                                   id="tanggal_surat" name="tanggal_surat" value="{{ old('tanggal_surat', $suratPemberitahuan->tanggal_surat->format('Y-m-d')) }}" required>
                            @error('tanggal_surat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('perihal') is-invalid @enderror" 
                                   id="perihal" name="perihal" value="{{ old('perihal', $suratPemberitahuan->perihal) }}" required>
                            @error('perihal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('isi_surat') is-invalid @enderror" 
                                      id="isi_surat" name="isi_surat" rows="5">{{ old('isi_surat', $suratPemberitahuan->isi_surat) }}</textarea>
                            @error('isi_surat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
