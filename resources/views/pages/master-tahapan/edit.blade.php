            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Edit Tahapan</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('master-tahapan.update', $masterTahapan) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_tahapan') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_tahapan', $masterTahapan->nama_tahapan) }}" required>
                                @error('nama_tahapan')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('urutan') is-invalid @enderror"
                                    id="urutan" name="urutan" value="{{ old('urutan', $masterTahapan->urutan) }}"
                                    min="1" required>
                                @error('urutan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
