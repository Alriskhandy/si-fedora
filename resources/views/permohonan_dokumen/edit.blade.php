        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('permohonan-dokumen.update', $permohonanDokumen) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('permohonan_id') is-invalid @enderror" id="permohonan_id"
                                    name="permohonan_id" disabled>
                                    <option value="{{ $permohonanDokumen->permohonan->id }}">
                                        {{ $permohonanDokumen->permohonan->nomor_permohonan }} -
                                        {{ $permohonanDokumen->permohonan->nama_dokumen }}
                                    </option>
                                </select>
                                @error('permohonan_id')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('is_ada') is-invalid @enderror" id="is_ada"
                                    name="is_ada" required>
                                    <option value="1"
                                        {{ old('is_ada', $permohonanDokumen->is_ada) == 1 ? 'selected' : '' }}>
                                        Dokumen Ada
                                    </option>
                                    <option value="0"
                                        {{ old('is_ada', $permohonanDokumen->is_ada) == 0 ? 'selected' : '' }}>
                                        Dokumen Tidak Ada
                                    </option>
                                </select>
                                @error('is_ada')
                                ...
                                @if ($permohonanDokumen->file_path)
                                    <div class="mb-2">
                                        ...
                                        <small class="text-muted d-block mt-1">
                                            File: {{ $permohonanDokumen->file_name }}
                                            ({{ $permohonanDokumen->file_size_formatted }})
                                        </small>
                                    </div>
                                @endif
