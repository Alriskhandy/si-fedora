...
<head>
    ...
    <meta name="description" content="Sistem Informasi Fedora - Halaman Tidak Ditemukan" />

    <title>404 - Halaman Tidak Ditemukan | SIFEDORA</title>
            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="mb-2">Halaman Tidak Ditemukan ⚠️</h5>
                        <p class="mb-4">
                            {{ $exception->getMessage() ?: 'Halaman yang Anda cari tidak ditemukan atau Anda perlu masuk terlebih dahulu.' }}
                        </p>
